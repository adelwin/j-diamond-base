/*
 * File Name       : CallerAwareDataFileMailDeliveryImpl.java
 * Class Name      : CallerAwareDataFileMailDeliveryImpl
 * Module Name     : pacs-data-extraction
 * Project Name    : pacs-base
 * Author          : adelwin.handoyo
 * Created Date    : 2015-02-12 19:58:00
 *
...
public class CallerAwareDataFileMailDeliveryImpl extends MailDeliveryImpl implements ICallerAwareBaseDelivery {
	
	@Override
	public void send(BaseExtractionDaoImpl caller) {
		this.setAttachment(caller.getFinalOutputFileName());
		this.send();
	}
